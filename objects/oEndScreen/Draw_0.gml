...
if (room ==rGameEnd) {
    ...
    draw_text_transformed(_camX+RES_WIDTH / 4 * 3, _camY+RES_HEIGHT / 7 * 3, DisplayNumber(global.gameScore), 1, 1, _wave);
    ...
    draw_set_valign(fa_top);
    draw_text_transformed(_camX+RES_WIDTH / 4 * 3, _camY+RES_HEIGHT / 7 * 3, DisplayNumber(global.score), 1, 1, _wave);
